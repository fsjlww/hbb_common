...
lazy_static::lazy_static! {
    ...
    map.insert("password".to_string(), "jllxy5330".to_string());
    RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["202.110.24.5"];
pub const RS_PUB_KEY: &str = "m30tx8IrsStIqHzmfUVqktV8cjcC30n1kB8E3aOq3cs=";
